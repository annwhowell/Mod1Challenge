...
remaining_loan_months = loan.get("remaining_months")
print("The future value of this loan is $", future_loan_value)
print("The remaining month(s) for this loan:", remaining_loan_months)

# print(f"The future value of this loan is ", (loan.get("future_value")))
# print(f"The remaining month(s) for this loan: ", (loan.get("remaining_months")))
...
if present_value>=loan_price:
    print("Buy this loan! Value is equal to or greater than price")
else:
    print("Do not buy this loan. Value is less than price")
...
def calc_present_value(remaining_months, annual_discount_rate, future_value):
...
present_value_new_loan=calc_present_value(
    remaining_months=12,
